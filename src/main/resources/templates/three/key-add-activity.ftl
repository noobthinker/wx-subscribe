        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="/back/key-add-activity-submit.html" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="nouse" onchange="changeIds()" class="form-control select2" multiple="multiple" data-placeholder="选择一个活动">
