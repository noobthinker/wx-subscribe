                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">文本回复</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">添加文本回复</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="/back/key-add-txt-submit.html" method="post">
                        <input type="hidden" name="type" value="KeyType.plainTxt">
                        <div class="card-body">
                            <div class="form-group row" id="magicTxt">
                                <label for="magicTxtInput" class="col-sm-2 control-label">接受文本，多个【,】分割</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="magicTxtInput" placeholder="标题" name="targetList">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 control-label">回复</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputPassword3" placeholder="回复" name="functionTxt">
                                </div>
                            </div>
                            <div class="form-group row">
