        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="/back/key-add-menuActivity-submit.html" method="post">
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 control-label">菜单</label>
                                <div class="col-sm-10">
                                    <select name="targetList" onchange="changeIds()" class="form-control select2"
                                            data-placeholder="选择一个菜单">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="functionTxt" class="form-control select2" data-placeholder="选择一个活动">
